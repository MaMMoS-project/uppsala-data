...
1. A new dataset has been added in PR 1.

   Add a file with name `1.added.md` with content:

   ```markdown
   New dataset <CHEMICAL_COMPOSITION>.
   ```
...
release this as uppsala-data version 0.1.0):

```markdown
## [uppsala-data 0.1.0](<url to 0.1.0 tag>) – <release date>

### Added

- New dataset <CHEMICAL_COMPOSITION>. ([#1](<url to PR 1>))
